...
namespace MyClassLibrary2.Migrations
{
    ...
    [Migration("20250116023301_InitialCreate")]
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.Calculation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Operand2 = 5.0,
                            Operator = "+",
                            PerformedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(7106),
                            Result = 15.0,
                            ShapeId = 1
                        },
                        new
                        {
                            ...
                            Operand2 = 4.0,
                            Operator = "/",
                            PerformedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(7116),
                            Result = 5.0,
                            ShapeId = 2
                        },
                        new
                        {
                            ...
                            Operand2 = 3.0,
                            Operator = "-",
                            PerformedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(7121),
                            Result = 4.0,
                            ShapeId = 3
                        });
                });
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.RockPaperScissors", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CalculationId = 1,
                            ComputerChoice = "sax",
                            PlayedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(7250),
                            PlayerChoice = "sten",
                            Result = "Vinst",
                            ShapeId = 1
                        },
                        new
                        {
                            ...
                            CalculationId = 2,
                            ComputerChoice = "sten",
                            PlayedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(7269),
                            PlayerChoice = "påse",
                            Result = "Vinst",
                            ShapeId = 2
                        });
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.Parallelogram", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            Area = 28.0,
                            CalculatedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(6763),
                            Perimeter = 18.0,
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.Rectangle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Area = 50.0,
                            CalculatedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(5784),
                            Perimeter = 30.0,
                            ShapeType = "Rectangle",
                            Height = 10.0,
                            Width = 5.0
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.Rhombus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 4,
                            Area = 48.0,
                            CalculatedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(6941),
                            Perimeter = 24.0,
                            ShapeType = "Rhombus",
                            Height = 8.0,
                            SideLength = 6.0
            ...
            modelBuilder.Entity("MyClassLibrary2.Models.Triangle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Area = 9.0,
                            CalculatedOn = new DateTime(2025, 1, 16, 3, 33, 0, 926, DateTimeKind.Local).AddTicks(6877),
                            Perimeter = 12.0,
                            ShapeType = "Triangle",
                            Base = 3.0,
                            Height = 6.0
